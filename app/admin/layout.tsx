 ...
 *
 * ── Why the guard lives HERE and not in the 22 pages ──────────────────────
 ...
 *
 * So protection is a PROPERTY OF THE ROUTE TREE, not a convention: page 23 is
 * guarded before its author writes a line of it. Twenty-one `requireAdminPage()`
 * calls at the top of twenty-two files would have been twenty-two chances to
 * forget, and the twenty-third page is the one that gets missed.
 *
