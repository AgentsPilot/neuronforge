      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        ...
        >
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-slate-900/95 to-slate-800/95 backdrop-blur-2xl rounded-3xl p-8 border border-white/20">
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-4 px-6 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl font-semibold text-white transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25"
                >
                  {isSubmitting ? (
          ...
          >
            <p className="text-slate-400">
              ...
              <span className="text-blue-400 font-medium">support@agentspilot.ai</span>
            </p>
          </motion.div>
        </motion.div>
      </div>
