 ...
 * `/api/v6/generate-ir-intent-contract`. This route has no known callers (the
 * P1 audit found zero consumers across `app/`, `components/`, `scripts/`,
 * `tests/`, and `public/`). Scheduled for deletion in the Pipeline B retirement
