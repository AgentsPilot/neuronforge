...
| **C-11** | `archived_records.user_id` mirrors the source FK: `REFERENCES auth.users(id) ON DELETE SET NULL`. Account deletion then treats live and archived rows alike. | Low | 2 |
