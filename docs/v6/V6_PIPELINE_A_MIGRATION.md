...
> **Status**: 📋 Planning + investigation in progress (no implementation yet)
...
| P6 — Retire rollout flag | ⬜ Blocked on P5 + cooling-off window | Collapse the dual-pipeline branch; remove `NEXT_PUBLIC_USE_V6_PIPELINE_A`; decide Pipeline B endpoints' fate |
