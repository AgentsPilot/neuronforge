> **ARCHIVED — 2026-08-31.** The `/onboarding-v2` route described here has been
> deleted. All new users now go to `/onboarding-chat`, and the middleware
> redirects there. Kept for the history of how capabilities and the build step
> were first wired; do not follow its routing instructions.
