...
- [x] **S1-T16** ✅ `docs/architecture/BUSINESS_OS_ENTITLEMENTS.md` written. **The CLAUDE.md Key Documentation row is PROPOSED in §4.30.5, not applied** — it needs the user's approval.
...
6. **A CLAUDE.md Key Documentation row is proposed, not added** — that needs the user's approval. Suggested wording is in §4.30.5.

#### 4.30.5 Proposed CLAUDE.md row (for the user to approve — NOT applied)
