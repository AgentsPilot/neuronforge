-- SQL to fix the Expense Processing Agent workflow
-- Agent ID: ee7f1270-6ba4-4787-a5ae-55e47ecfb155

UPDATE agents
SET
  workflow_definition = jsonb_set(
    workflow_definition,
    '{workflow}',
    '[
      {
...
SELECT
  id,
  name,
  workflow_definition->'workflow'->2->'scatter'->>'input' as step3_scatter_input,
  workflow_definition->'workflow'->3->>'input' as step4_transform_input,
  updated_at
FROM agents
WHERE id = 'ee7f1270-6ba4-4787-a5ae-55e47ecfb155';

-- Expected results:
-- step3_scatter_input should be: {{step1.data.emails}}
-- step4_transform_input should be: {{step3.data}}
