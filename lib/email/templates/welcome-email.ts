...
export function generateWelcomeEmail(data: WelcomeEmailData): {
  ...
  const content = `
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 24px; background-color: ${c.mutedSurface}; border-radius: ${c.radius}; border: 1px solid ${c.line};">
      <tr>
        <td style="padding: 20px;">
          ...
          <p style="margin: 0; font-size: 16px; color: ${c.ink}; font-weight: 500;">
            ${serviceInterest}
          </p>
        </td>
      </tr>
    ...
    ${message ? `
    <!-- Original Message -->
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 24px; background-color: ${c.mutedSurface}; border-radius: ${c.buttonRadius}; border-${locale === 'he' ? 'right' : 'left'}: 4px solid ${branding.primaryColor};">
      <tr>
        <td style="padding: 16px 20px;">
          <p style="margin: 0 0 8px; font-size: 12px; font-weight: 600; color: ${c.inkFaint}; text-transform: uppercase; letter-spacing: 0.5px;">
            ${t.yourMessageLabel[locale]}
          </p>
          <p style="margin: 0; font-size: 14px; color: ${c.inkMuted}; line-height: 1.6; font-style: italic;">
    ...
    <!-- What's Next -->
    ${emailNoticeBox(t.whatsNext[locale], 'info', brandingWithLocale)}
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 24px 0;">
      <tr>
        <td>
          <p style="margin: 0 0 12px; font-size: 15px; color: ${c.ink};">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 24px 0; padding-top: 24px; border-top: 1px solid ${c.line};">
      <tr>
        <td>
          <p style="margin: 0 0 8px; font-size: 14px; color: ${c.inkMuted}; line-height: 1.6;">
            ${t.lookingForward[locale]}
          </p>
          <p style="margin: 0; font-size: 14px; color: ${c.ink}; font-weight: 500;">
    ...
    ${websiteUrl ? `
    <p style="margin: 24px 0 0; font-size: 13px; color: ${c.inkFaint};">
