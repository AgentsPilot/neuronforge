...
export const publicMessages: Catalogue = {
  en: {
    // ── Proposals ─────────────────────────────────────────────────────────
    'proposal.document.open_prompt': 'Open the full proposal before accepting',
  'proposal.document.opened': 'Opened — you can accept below',
  'proposal.document.required': 'Please open the proposal above before accepting.',
  'proposal.header': 'Your quote',
  'proposal.greeting': 'Your quote',
    'proposal.greeting_named': 'Hello {name},',
    'proposal.intro': 'Here is the quote for the work we discussed.',
    'proposal.terms': 'Payment terms',
    'proposal.terms_net': '{days} days from invoice',
    'proposal.terms_on_receipt': 'Due on receipt',
    'proposal.total': 'Total',
    'proposal.stages': 'How it is paid',
    'proposal.valid_until': 'Valid until {date}',
    'proposal.accept': 'Accept this quote',
    'proposal.accept_with_due': 'Accept — {amount} due now',
    'proposal.decline': 'Decline',
    'proposal.back': 'Back',
    'proposal.decline.title': 'Declining this quote',
    'proposal.decline.why': 'It helps to know why — we may be able to send a revised version.',
    'proposal.decline.send': 'Send',
    'proposal.decline.note_placeholder': 'Anything you would like to add (optional)',
    'proposal.decline.reason.too_expensive': 'The price is too high',
    'proposal.decline.reason.timing': 'The timing does not suit',
    'proposal.decline.reason.scope': 'Not the scope I had in mind',
    'proposal.decline.reason.chose_other': 'I went with another quote',
    'proposal.decline.reason.other': 'Something else',
    'proposal.state.accepted.title': 'Quote accepted',
    // Says what actually happened. "We'll be in touch" was written when nothing
    // followed an acceptance; an invoice is now raised and emailed, and a
    // client who is told to wait for contact does not go looking for it.
    // Says nothing about an email: when there is money due on acceptance the
  // client is taken straight to the invoice and no email is sent, precisely
  // so there is only one way to pay. The button below is the way back to it.
  'proposal.state.accepted.body': 'Thank you — your quote is accepted.',
    'proposal.pay_now': 'Pay now',
    'proposal.view_invoice': 'View invoice',
    'proposal.state.declined.title': 'Quote declined',
    'proposal.state.declined.body': 'Thank you for letting us know.',
    'proposal.state.expired.title': 'This quote has expired',
    'proposal.state.expired.body': 'Get in touch and we will gladly send an up-to-date one.',
    'proposal.state.withdrawn.title': 'This quote is no longer available',
    'proposal.state.withdrawn.body': 'Please contact us if you would still like to go ahead.',
    'proposal.state.superseded.title': 'This quote was updated',
    'proposal.state.superseded.body': 'A newer version was sent to you — please open the most recent email.',
    'proposal.state.not_found.title': 'We could not find this quote',
    'proposal.state.not_found.body': 'Please open the link from your email, or contact the business directly.',
    // ── Booking management ────────────────────────────────────────────────
    ...
    /*
     * Why a change was refused, in the reader's language.
     *
     * These arrived from the API as English sentences and were printed
     * verbatim, so a Hebrew page showed a Hebrew heading, a Hebrew button, and
     * an English reason between them. The route now sends a code and the
     * numbers behind it; the sentence is written here.
     */
    rescheduleTooLate: 'This booking can only be changed more than {hours} hours before it starts.',
    cancelTooLate: 'This booking can only be cancelled more than {hours} hours before it starts.',
    invalidLink: 'This link has expired. Ask the business for a new one.',
    notReschedulable: 'This booking is no longer open for changes.',
    notCancellable: 'This booking can no longer be cancelled.',
    slotTaken: 'That time was taken while you were choosing. Pick another.',
    /** The appointment as it stands, shown beside the refusal. */
    yourBookingIs: 'Your appointment',
    ...
    fileTooLarge: 'That file is larger than 10MB. Try a smaller one.',
    fileTypeNotAccepted: 'That kind of file cannot be sent here. Images, PDFs, and Word, Excel or text documents all work.',
    uploadNotCollecting: 'This form is no longer accepting files.',
    remove: 'Remove',
    select: 'Select...',
  ...
  es: {
    // ── Presupuestos ──────────────────────────────────────────────────────
    'proposal.document.open_prompt': 'Abre el presupuesto completo antes de aceptar',
  'proposal.document.opened': 'Abierto — ya puedes aceptar',
  'proposal.document.required': 'Abre el presupuesto de arriba antes de aceptar.',
  'proposal.header': 'Tu presupuesto',
  'proposal.greeting': 'Tu presupuesto',
    'proposal.greeting_named': 'Hola {name},',
    'proposal.intro': 'Aquí tienes el presupuesto del trabajo que hablamos.',
    'proposal.terms': 'Plazo de pago',
    'proposal.terms_net': '{days} días desde la factura',
    'proposal.terms_on_receipt': 'Pago al recibir',
    'proposal.total': 'Total',
    'proposal.stages': 'Cómo se paga',
    'proposal.valid_until': 'Válido hasta el {date}',
    'proposal.accept': 'Aceptar el presupuesto',
    'proposal.accept_with_due': 'Aceptar — {amount} a pagar ahora',
    'proposal.decline': 'Rechazar',
    'proposal.back': 'Volver',
    'proposal.decline.title': 'Rechazar este presupuesto',
    'proposal.decline.why': 'Saber el motivo ayuda — quizá podamos enviarte una versión revisada.',
    'proposal.decline.send': 'Enviar',
    'proposal.decline.note_placeholder': 'Algo que quieras añadir (opcional)',
    'proposal.decline.reason.too_expensive': 'El precio es muy alto',
    'proposal.decline.reason.timing': 'No me viene bien la fecha',
    'proposal.decline.reason.scope': 'No es el alcance que tenía en mente',
    'proposal.decline.reason.chose_other': 'Elegí otro presupuesto',
    'proposal.decline.reason.other': 'Otro motivo',
    'proposal.state.accepted.title': 'Presupuesto aceptado',
    'proposal.state.accepted.body': 'Gracias — tu presupuesto está aceptado.',
    'proposal.pay_now': 'Pagar ahora',
    'proposal.view_invoice': 'Ver factura',
    'proposal.state.declined.title': 'Presupuesto rechazado',
    'proposal.state.declined.body': 'Gracias por avisarnos.',
    'proposal.state.expired.title': 'Este presupuesto ha caducado',
    'proposal.state.expired.body': 'Escríbenos y te enviamos uno actualizado con gusto.',
    'proposal.state.withdrawn.title': 'Este presupuesto ya no está disponible',
    'proposal.state.withdrawn.body': 'Contáctanos si todavía quieres seguir adelante.',
    'proposal.state.superseded.title': 'Este presupuesto se actualizó',
    'proposal.state.superseded.body': 'Te enviamos una versión más reciente — abre el último correo.',
    'proposal.state.not_found.title': 'No encontramos este presupuesto',
    'proposal.state.not_found.body': 'Abre el enlace desde tu correo o contacta con el negocio.',
    ...
    rescheduleTooLate: 'Esta reserva solo se puede cambiar con más de {hours} horas de antelación.',
    cancelTooLate: 'Esta reserva solo se puede cancelar con más de {hours} horas de antelación.',
    invalidLink: 'Este enlace ha caducado. Pide uno nuevo al negocio.',
    notReschedulable: 'Esta reserva ya no admite cambios.',
    notCancellable: 'Esta reserva ya no se puede cancelar.',
    slotTaken: 'Ese horario se ocupó mientras elegías. Elige otro.',
    yourBookingIs: 'Tu cita',
    ...
    fileTooLarge: 'Ese archivo supera los 10 MB. Prueba con uno más pequeño.',
    fileTypeNotAccepted: 'Ese tipo de archivo no se puede enviar aquí. Sí funcionan imágenes, PDF y documentos de Word, Excel o texto.',
    uploadNotCollecting: 'Este formulario ya no acepta archivos.',
    remove: 'Quitar',
    select: 'Seleccionar...',
    submitting: 'Enviando...',
  ...
  he: {
    // ── הצעות מחיר ────────────────────────────────────────────────────────
    'proposal.document.open_prompt': 'פתחו את הצעת המחיר המלאה לפני האישור',
  'proposal.document.opened': 'נפתח — אפשר לאשר',
  'proposal.document.required': 'יש לפתוח את הצעת המחיר שלמעלה לפני האישור.',
  'proposal.header': 'הצעת המחיר שלך',
  'proposal.greeting': 'הצעת המחיר שלך',
    'proposal.greeting_named': 'שלום {name},',
    'proposal.intro': 'מצורפת הצעת מחיר לעבודה שדיברנו עליה.',
    'proposal.terms': 'תנאי תשלום',
    'proposal.terms_net': '{days} יום מקבלת החשבונית',
    'proposal.terms_on_receipt': 'לתשלום עם קבלת החשבונית',
    'proposal.total': 'סה״כ',
    'proposal.stages': 'אופן התשלום',
    'proposal.valid_until': 'בתוקף עד {date}',
    'proposal.accept': 'אישור ההצעה',
    'proposal.accept_with_due': 'אישור — {amount} לתשלום עכשיו',
    'proposal.decline': 'דחייה',
    'proposal.back': 'חזרה',
    'proposal.decline.title': 'דחיית ההצעה',
    'proposal.decline.why': 'הסיבה עוזרת לנו — ייתכן שנוכל לשלוח גרסה מתוקנת.',
    'proposal.decline.send': 'שליחה',
    'proposal.decline.note_placeholder': 'משהו שתרצו להוסיף (לא חובה)',
    'proposal.decline.reason.too_expensive': 'המחיר גבוה מדי',
    'proposal.decline.reason.timing': 'התזמון לא מתאים',
    'proposal.decline.reason.scope': 'ההיקף לא מה שחשבתי',
    'proposal.decline.reason.chose_other': 'בחרתי בהצעה אחרת',
    'proposal.decline.reason.other': 'משהו אחר',
    'proposal.state.accepted.title': 'ההצעה אושרה',
    'proposal.state.accepted.body': 'תודה — ההצעה אושרה.',
    'proposal.pay_now': 'לתשלום',
    'proposal.view_invoice': 'צפייה בחשבונית',
    'proposal.state.declined.title': 'ההצעה נדחתה',
    'proposal.state.declined.body': 'תודה שהודעתם לנו.',
    'proposal.state.expired.title': 'תוקף ההצעה פג',
    'proposal.state.expired.body': 'צרו קשר ונשמח לשלוח הצעה מעודכנת.',
    'proposal.state.withdrawn.title': 'ההצעה כבר לא זמינה',
    'proposal.state.withdrawn.body': 'צרו קשר אם עדיין תרצו להתקדם.',
    'proposal.state.superseded.title': 'ההצעה עודכנה',
    'proposal.state.superseded.body': 'נשלחה אליכם גרסה חדשה יותר — פתחו את המייל האחרון.',
    'proposal.state.not_found.title': 'לא מצאנו את ההצעה',
    'proposal.state.not_found.body': 'פתחו את הקישור מהמייל, או צרו קשר עם העסק.',
    ...
    rescheduleTooLate: 'אפשר לשנות את הפגישה רק יותר מ־{hours} שעות לפני תחילתה.',
    cancelTooLate: 'אפשר לבטל את הפגישה רק יותר מ־{hours} שעות לפני תחילתה.',
    invalidLink: 'הקישור הזה פג. אפשר לבקש מהעסק קישור חדש.',
    notReschedulable: 'לא ניתן עוד לשנות את הפגישה הזו.',
    notCancellable: 'לא ניתן עוד לבטל את הפגישה הזו.',
    slotTaken: 'השעה הזו נתפסה בזמן שבחרת. אפשר לבחור אחרת.',
    yourBookingIs: 'הפגישה שלך',
    ...
    fileTooLarge: 'הקובץ גדול מ‑10MB. נסו קובץ קטן יותר.',
    fileTypeNotAccepted: 'אי אפשר לשלוח כאן קובץ מסוג זה. תמונות, PDF ומסמכי Word, Excel או טקסט — כן.',
    uploadNotCollecting: 'הטופס כבר לא מקבל קבצים.',
    remove: 'הסרה',
    select: 'בחר/י...',
    submitting: 'שולח...',
