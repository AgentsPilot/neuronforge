...
export type BlockType =
  ...
  | 'video'
  | 'contact_form'
  // Generated by `WebsiteGenerationService` (:1120) and editable in the block
  // editor, but missing from this union — so the editor's `block_type ===
  // 'footer'` branch was reported as a comparison that could never be true.
  | 'footer';
